...
export default function Page() {
  return (
      <div>
          ...
          <h2>
              If you want to know more about me, check out the <a href="/about" className="text-indigo-500">about</a> page.
          </h2>
          <h2>
              Also check out my <a href="/links" className="text-indigo-500">links</a>!
          </h2>
          <h2>
              If you want to see my <a href="/blog" className="text-indigo-500">blog</a>, you can do so here.
          </h2>
      </div>
  );
}
